...
describe('calcul', function () {
    ...
    describe('#Grosse Opération', function () {
        ...
        it('Beaucoup de chiffres pour pas grand chose => 1', function () {
            calc.calcExpr("(((1,1+2)+3,14+4+(5+6+7)+(8+9+10)*4267387833344334647677634)/2*553344300034334349999000)/31878018903828899277492024491376690701584023926880").should.eql("1");
        });
